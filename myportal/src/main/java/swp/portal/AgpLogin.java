...
public class AgpLogin extends PolymerTemplate<AgpLogin.AgpLoginModel> {
	...
	public AgpLogin() {
		...
		vaadinLoginForm.setI18n(createLoginI18n());		
	...
	private LoginI18n createLoginI18n(){
		...
		i18n.getForm().setTitle("Altegeräte Portal Login");
		i18n.setAdditionalInformation("Bitte loggen sie sich mit ihren OSCA Daten ein!");
